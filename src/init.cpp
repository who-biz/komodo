...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-cashier", strprintf(_("Signal to peers that you are a cashier node for CHIPS (default: %u)"), 0));
    strUsage += HelpMessageOpt("-dealer", strprintf(_("Signal to peers that you are a dealer node for CHIPS (default: %u)"), 0));
    if (showDebug)
